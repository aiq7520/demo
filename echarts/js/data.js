...
var sortCarCount = carCount.sort(function (a,b) {return b - a;})
var seriesData={
			name: '车库',
            type: 'scatter',
            coordinateSystem: 'geo',
            data: convertData(detailData),
            symbolSize: function (val) {//该方法被覆盖了     
                return 15;
            },
            label: {
                normal: {
            ...
            itemStyle: {
                normal: {
					...
					var colordata = series.data.value[2];
					var colortou =colordata/sortCarCount[0];
					colortou=colortou<0.5? 0.5:colortou;
					var colorStr = "rgba(255, 255, 0,"+colortou+")";
					return colorStr;
					}//ddb926
                }
            }
